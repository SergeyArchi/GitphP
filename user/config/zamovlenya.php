            ...
            foreach($zm as $zam){
                ...
                <div class="card mb-4 rounded-3 shadow-sm">
                  <div class="card-header py-3">
                    <h4 class="my-0 fw-normal"> Замовлення номер: '.$zam[0].'</h4>
                  </div>
                  <div class="card-body">
                    <ul class="list-unstyled mt-3 mb-4">
                      <li>Користувач: '.$zam[6].' (id: '.$zam[1].')</li>
                      <li>Тип замовлення: '.$zam[2].'</li>
                      <li>Статус виконання: '.$zam[4].'</li>
                      <li>Ціна: '.$zam[7].'</li>
                    </ul>
                    <a class="w-100 btn btn-lg btn-outline-primary" href="info-zamovlenya.php?idu='.$zam[1].'&idz='.$zam[0].'">Детально</a>
                  </div>
                </div>
              </div>
                ';
