...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    ...
    <?php
            ...
            <a class="navbar-brand col-sm-3 col-md-2 mr-0" >Вітаю '.($_COOKIE['fname_user']).'</a>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4"><div class="chartjs-size-monitor" style="position: absolute; inset: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
          <h3 style="text-align: center">Інформація про профіль: <p style="font-size: 32px;"><?=($_COOKIE['user_user'])?> </p> <a class="btn btn-sm btn-outline-secondary" href="#">Редагувати профіль</a></h3>
          <div class="table-responsive">
            <table class="table table-striped table-sm">
                <hr>
                <h4>ПІБ: <?=($_COOKIE['lname_user'])?> <?=($_COOKIE['fname_user'])?> <?=($_COOKIE['oname_user'])?></h4>
                <h4>Статус:  Користувач/User</h4>
                <h4>Скринька:  <?=($_COOKIE['email_user'])?></h4>
                <br>
                <h5>Створено заказів: 0</h5>
                <h5>Заказів підтверджено: 0</h5>
                <h5>Заказів відхилено: 0</h5>
                <h5>Закази, які очікують розгляду: 0</h5>
                <br>
                <h5 class="nav-link">Замовлено заказів на суму: 0.0 грн.</h5>
                <p style="color: black;">
                <a class="btn btn-sm btn-outline-secondary" href="zamovlenya.php?id=<?=($_COOKIE['id_user'])?>">Переглянути історію замовлень</a>
                <a class="btn btn-sm btn-outline-secondary" href="createzam.php?id=<?=($_COOKIE['id_user'])?>">Створити нове замовлення</a>
                </p>
                <br>
                <br>
                <br>
